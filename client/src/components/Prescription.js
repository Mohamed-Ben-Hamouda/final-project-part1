...
//             />
//           )}
//           <CheckCircleTwoTone twoToneColor="#52c41a" /> Préscription
//           <p>{this.state.patient.soin.datePrescrition} </p>
//           <p>{this.state.patient.soin.traitement} </p>
//         </Card>
...
//   };
// };
// export default connect(mapStateToProps, { loadInfermier })(Prescription);
